...
export class EmployeeDoesNotExistException extends HttpException {
	constructor() {
		super('Business does not exist', HttpStatus.NOT_FOUND);
	}
}

export class BusinessDoesNotExistException extends HttpException {
	constructor() {
		super('Employee does not exist', HttpStatus.NOT_FOUND);
	}
}
